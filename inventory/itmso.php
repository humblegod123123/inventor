    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="borrow.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class='fas fa-hand-holding me-4'></i>Borrow</a>
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
								...
								<td><a href="itmsoviewmore.php?item_id=<?php echo($row['item_id']);?>" /><i class="far fa-eye"></i></a></td></tr>
								<?php
								}
								echo "</tbody></table>";
