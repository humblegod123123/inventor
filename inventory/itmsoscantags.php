...
<head>
    ...
    <title>AIMS ITMSO Scan Tags</title>
<style>
table, tr, td {
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
				...
				<a href="itmsoscantags.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fa fa-tags me-4"></i></i>Scan Tags</a>
        ...
        <div id="page-content-wrapper">
			...
			<div class="container-fluid px-4">
				<div class="scanform">
					...
					<div class="bcscan">
					<h3>Barcode</h3>
						<?php echo '<a href="itmsobarcodescan.php"><img src="img/barcode.png" width="150px" height="150px"></a>';?>
					</div>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 					
					<div class="rfidscan">
					<h3>RFID</h3>
