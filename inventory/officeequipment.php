...
<head>
    ...
    <title>AIMS Office Equipment</title>
</head>
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">Equipment</div>
            <div class="list-group list-group-flush my-3">
                <a href="officeequipment.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i class="fas fa-tachometer-alt me-4"></i>Dashboard</a>
                <a href="officeequipmentadditem.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fa fa-cart-arrow-down me-4"></i></i>Add item</a>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
								...
								$query2=mysqli_query($con,"Select no from item") or die ("Database query failed: $query2" . mysqli_error());
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
								...
								$sql = "SELECT rfid, barcode, sn, pcode, particular, description, qty, amount, department, building, officeroom, issuedto, dateacq, licensed, status, remark FROM item";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) {
								// output data of each row
								while($row = $result->fetch_assoc()) {
								echo "</td><td>". $row["particular"]. "</td><td>" . $row["description"] 
								. "</td><td>" . $row["status"] . "</td>";
								echo '<td><button type="button" class="btn btn-primary"><div class="popup-link"><i class="far fa-eye"></i></div></button></td></tr>';
								}
								echo "</table>";
								} else { echo "0 results"; }
								$conn->close();
